...
//
//    //根据表类型查询,某个公司
////    @Select("select * from Table1 where orgName= #{orgName} and date >= #{fromData} and date <= #{endData} and filetype = #{filetype}")
    ArrayList<Table1> findByOrgName(@Param("orgName") String orgName, @Param("fromData") String fromData, @Param("endData") String endData, @Param("filetype") String filetype);
//
//
//    //根据表类型查询,所有数据
////    @Select("select * from Table1 where  date >= #{fromData} and date <= #{endData} and filetype = #{filetype}")
    ArrayList<Table1> find( @Param("fromData") String fromData, @Param("endData") String endData, @Param("filetype") String filetype);
//
//
//    //单个下载
