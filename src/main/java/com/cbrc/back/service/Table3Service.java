...
public class Table3Service {
    ...
    public void insert(Table3 table3,String userid,String taskCompleteId){
        ...
        taskCompleteTmp.setCompletetime(table3.getDate());
...
//                table3Tmp.setPeriod(task.getPeriod());
    ...
    public List<Table3> collectFind(List<String> taskCompleteListId){

        List<Table3> table3s = table3Mapper.collectFind(taskCompleteListId);
